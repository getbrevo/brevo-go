...
type MasterDetailsResponse struct {
	...
	BillingInfo *MasterDetailsResponseBillingInfo `json:"billingInfo,omitempty"`
	PlanInfo    *MasterDetailsResponsePlanInfo    `json:"planInfo,omitempty"`
}
